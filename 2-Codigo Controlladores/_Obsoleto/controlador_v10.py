...
class Controlador(app_manager.RyuApp):
    ...
    def agregar_conexion_entre_switches(self, dpid1, dpid2, puerto1, puerto2):
        pass


    def recalcular_caminos_up(self):
        pass


    def recalcular_caminos_down(self):
        ...
        filename = 'caminos_nuevos.json'
        with open(filename, 'w') as fd:
    	    fd.write(json.dumps(diccionario_nuevo))

        os.system('python app_crea_json.py caminos_nuevos.json')
