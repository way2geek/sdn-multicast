...
class Controlador(app_manager.RyuApp):
    ...
    def eliminar_conexion_entre_switches(self, dpid_1, dpid_2, port_1, port_2):
        lista_group_id = []
        ...
        for group_id in self.switches_por_gid:
            ...
            if switch_a in switches:
                if puerto_1 in self.switches_por_gid[group_id][switch_a]:
                    ...
                    print('borre puerto {}'.format(puerto_1))
            if switch_b in switches:
                if puerto_2 in self.switches_por_gid[group_id][switch_b]:
                    ...
                    print('borre puerto {}'.format(puerto_2))


    def agregar_puertos_switch_groupID(self, dpid_1, puerto_1, dpid_2, puerto_2):
        pass


    def cambiar_flujos_grupo_switch(self, switch_1, port_1):
        datapath_1 = self.datapath_switch[switch_1]['datapath']
        #datapath_2 = self.datapath_switch[switch_2]['datapath']
        pass
    ...
    def agregar_conexion_entre_switches(self, dpid_1, dpid_2, puerto1, puerto2):
        ...
        self.conexion_switches[switch_1].update({switch_2:puerto1})
        self.conexion_switches[switch_2].update({switch_1:puerto2})
