...
class ProjectController(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        if src not in self.net:
            ...
            # self.net.add_edge(dpid,src,inpuerto=puertoin)
            # print puertoin

            self.net.add_edge(dpid,src,inpuerto={'port':puertoin})     #original
            # self.net.add_edge(dpid,src)      #hice correccion
        ...
        out = datapath.ofproto_parser.OFPPacketOut(
            datapath=datapath, buffer_id=msg.buffer_id, in_port=puertoin,
            actions=actions)
