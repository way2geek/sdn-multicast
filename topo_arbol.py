...
class Topologia(Topo):
    ...
    def build(self):
        ...
        h4 = self.addHost('h4', mac="00:00:00:00:11:14", ip="172.168.1.14/24")
        h5 = self.addHost('h5', mac="00:00:00:00:11:15", ip="172.168.1.15/24")
        h6 = self.addHost('h6', mac="00:00:00:00:11:16", ip="172.168.1.16/24")

        info( '*** Adding links\n')
        self.addLink(s1, s2, 1, 1)
        self.addLink(s2, s3, 2, 9)
        self.addLink(s2, s4, 3, 9)

        self.addLink(h1, s3, 1, 1)
        self.addLink(h2, s3, 1, 2)
        self.addLink(h3, s3, 1, 3)
        self.addLink(h4, s3, 1, 4)
        self.addLink(h5, s4, 1, 5)
        self.addLink(h6, s4, 1, 6)
...
if __name__ == '__main__':
    ...
    h4.cmd('ip route add default via 172.168.1.1')
    h5.cmd('ip route add default via 172.168.1.1')
    h6.cmd('ip route add default via 172.168.1.1')
