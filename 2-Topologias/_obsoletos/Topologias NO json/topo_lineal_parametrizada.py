...
class Topologia(Topo):
    ...
    def build(self):
        ...
        h2 = self.addHost('h2', mac="00:00:00:00:11:12", ip="192.168.1.12/24", defaultRoute= '192.168.1.1')
        h3 = self.addHost('h3', mac="00:00:00:00:11:13", ip="192.168.1.13/24", defaultRoute= '192.168.1.1')
