...
class Topologia(Topo):
    ...
    def build(self):
        ...
        info( '*** Adding hosts\n')
        h1 = self.addHost('h1', mac="00:00:00:00:11:11", ip="172.16.10.10/24", defaultRoute='192.168.1.1')
        h2 = self.addHost('h2', mac="00:00:00:00:11:12", ip="172.16.20.20/24", defaultRoute='192.168.1.1')
        h3 = self.addHost('h3', mac="00:00:00:00:11:13", ip="172.16.30.30/24", defaultRoute='192.168.1.1')
        h4 = self.addHost('h4', mac="00:00:00:00:11:14", ip="192.168.1.1/24", defaultRoute='192.168.1.1')
        h5 = self.addHost('h5', mac="00:00:00:00:11:15", ip="192.168.1.2/24", defaultRoute='192.168.1.1')
        h6 = self.addHost('h6', mac="00:00:00:00:11:16", ip="192.168.1.3/24", defaultRoute='192.168.1.1')
