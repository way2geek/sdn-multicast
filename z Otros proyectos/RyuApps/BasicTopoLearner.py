...
from ryu.topology.api import get_switch, get_link, get_host, get_all_host   #agregue get_host y get_all_host
import copy
import time
...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def handler_switch_enter(self, ev):
        ...
        print(" \t" + "Current hosts:")
        for l in self.topo_raw_hosts:
            print (" \t\t" + str(l))
        # Agregado mio
        self.topo_raw_hosts = copy.copy(get_all_host(self))
        for l in self.topo_raw_hosts:
            print (" \t\t" + str(l))
        #fin agregado mio
